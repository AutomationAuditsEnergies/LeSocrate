...
═══════════════════════════════════════════════════
REGLE #1 -- FIDELITE AU CONTENU SOURCE
═══════════════════════════════════════════════════

- Reformule FIDELEMENT le contenu source. N'invente RIEN.
- Tu peux reformuler, illustrer avec des exemples ISSUS DU TEXTE, expliquer autrement.
- Le fond doit rester strictement fidele au contenu fourni.
- Si le contenu est court, le resultat sera court. Ne rallonge JAMAIS artificiellement.
...
Le script doit suivre cette structure implicite (sans la nommer) :

1. ACCROCHE (2-3 phrases)
   Introduis le sujet de façon engageante. Pas de "Module 2, Partie 1".
   Ex : "Alors, aujourd'hui on attaque un sujet qui est vraiment au cœur de votre métier."
...
3. CLÔTURE (1-2 phrases)
   Soit une conclusion naturelle du sujet
   Soit une transition vers la suite : "On va s'arrêter là pour l'instant"
   JAMAIS de titre de chapitre suivant annoncé
