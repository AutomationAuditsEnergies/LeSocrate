...
export default function Landing() {
  ...
  return (
    <div className="bg-white text-[#1E293B] transition-colors duration-300" style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
      ...
      {/* Hero */}
      <section className="relative min-h-screen flex flex-col justify-center overflow-hidden" style={{ backgroundImage: 'url(/fond-hero2.png)', backgroundSize: 'cover', backgroundPosition: 'center 15%' }}>
