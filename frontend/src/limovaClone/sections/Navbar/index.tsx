...
export const Navbar = () => {
  ...
  return (
    <div className={`cadrenza-navbar ${scrolled ? "cadrenza-navbar--scrolled" : ""} box-border caret-transparent text-[15.3846px] tracking-[-0.107692px] leading-[21.5385px] outline-[3px] fixed no-underline w-screen z-[100] px-[19.2308px] py-[15.3846px] top-0 inset-x-0 md:text-[14.2222px] md:tracking-[-0.0995556px] md:leading-[19.9111px] md:px-[28.4444px] md:py-[21.3333px]`}>
