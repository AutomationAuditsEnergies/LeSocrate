export const CharlyContent = () => {
  return (
    <div className="self-center box-border caret-transparent gap-x-[23.0769px] flex flex-col text-[15.3846px] col-end-[-1] col-start-4 tracking-[-0.107692px] leading-[21.5385px] min-h-[auto] min-w-[auto] outline-[3px] gap-y-[23.0769px] no-underline md:gap-x-8 md:text-[14.2222px] md:tracking-[-0.0995556px] md:leading-[19.9111px] md:gap-y-8">
      <div className="box-border caret-transparent gap-x-[11.5385px] flex flex-col text-[15.3846px] tracking-[-0.107692px] leading-[21.5385px] min-h-[auto] min-w-[auto] outline-[3px] gap-y-[11.5385px] no-underline md:gap-x-[10.6667px] md:text-[14.2222px] md:tracking-[-0.0995556px] md:leading-[19.9111px] md:gap-y-[10.6667px]">
        ...
        <div className="box-border caret-transparent text-[color(srgb_1_1_1_/_0.73)] text-[15.3846px] tracking-[-0.107692px] leading-[21.5385px] min-h-[auto] min-w-[auto] outline-[3px] no-underline w-full mt-[3.84615px] md:text-[14.2222px] md:tracking-[-0.0995556px] md:leading-[19.9111px] md:mt-[3.55556px]">
          <p className="box-border caret-transparent text-[15.3846px] tracking-[-0.107692px] leading-[21.5385px] outline-[3px] no-underline md:text-[14.2222px] md:tracking-[-0.0995556px] md:leading-[19.9111px]">
            Connectée à tous vos outils du quotidien, et à la plateforme Cadrenza,
            elle exécute vos missions depuis un simple message sur WhatsApp.
          </p>
        </div>
      </div>
